...
import { ChevronDownIcon, CloseIcon, DownloadIcon, UploadIcon } from "../Icons";
            ...
            >
              ...
              <ButtonGroup className="w-full">
                ...
                <Dropdown className="dark:bg-slate-800" placement="top-end">
                  ...
                  >
                    {BackgroundsPatternsData.map((pattern) => {
                      const { Icon, technology } = pattern;
              ...
              {bannerCardImageFile && (
                <>
                  ...
                  <Button
                    ...
                    variant="shadow"
                    onClick={() => setBannerCardImageFile("")}
